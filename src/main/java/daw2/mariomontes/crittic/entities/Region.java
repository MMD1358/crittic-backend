package org.iesalixar.daw2.mariomontes.dwese_ticket_logger_api.entities;
...
public class Region {
    ...
    // Campo que almacena la imagen de la región.
    @Column(name = "image", nullable = false, length = 100) // Define la columna correspondiente en la tabla.
     ...
     */
    public Region(String code, String name, String image) {
        this.code = code;
        this.name = name;
        this.image = image;
    }
