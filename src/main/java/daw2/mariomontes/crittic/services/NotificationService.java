...
import org.iesalixar.daw2.mariomontes.dwese_ticket_logger_api.mappers.NotificationMapper;
...
/**
 * Servicio para gestionar las notificaciones en la aplicacion.
 * Permite guardar, recuperar todas las notificaciones y obtener las notificaciones de un usuario especifico.
 */
@Service
        ...
        return notificationRepository.save(notification)
                ...
                .doOnSuccess(savedNotification ->
                        ...
                        Mono.fromRunnable(() -> messagingTemplate.convertAndSend(
                                ...
                                .subscribeOn(Schedulers.boundedElastic()) // Se ejecuta en un pool de hilos elástico para
                                // evitar bloqueos
