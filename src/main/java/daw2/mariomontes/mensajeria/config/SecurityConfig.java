package daw2.mariomontes.mensajeria.config;

import daw2.mariomontes.mensajeria.services.CustomUserDetailsService;
        ...
        http
                .authorizeHttpRequests(auth -> {
                    logger.debug("Configurando autorización de solicitudes HTTP");
                            auth
                                    ...
                                    .requestMatchers("/regions", "/provinces").hasRole("MANAGER") // Solo MANAGER
                ...
                .formLogin(form -> {
                    ...
                    form
                            ...
                            .defaultSuccessUrl("/") // Redirige al iniciar después del login
                            .permitAll();           // Permite acceso a la págian de login a todos los usuarios
                })
                .oauth2Login(oauth2 -> {
